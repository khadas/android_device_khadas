...
define update-aml_upgrade-conf
	...
	$(if $(filter $(BUILD_WITH_AVB),true),,\
	@echo "BUILD_WITH_AVB $(BUILD_WITH_AVB) not true so remove vbmeta.img in $(PACKAGE_CONFIG_FILE)";\
	sed -i '/"vbmeta.img"/d' $(PACKAGE_CONFIG_FILE))

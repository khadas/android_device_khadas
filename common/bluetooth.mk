...
PRODUCT_COPY_FILES += device/khadas/common/tools/BCM40183B2_26M.hcd:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/BCM4330.hcd
...
ifeq ($(BCM_BLUETOOTH_LPM_ENABLE), true)
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_vendor_lpm.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_vendor.conf
else
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_vendor.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_vendor.conf
endif
endif
endif
...
ifeq ($(BLUETOOTH_USE_BPLUS), true)
ifeq ($(BCM_BLUETOOTH_LPM_ENABLE), true)
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_vendor_AP6210_lpm.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_vendor.conf
else
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_vendor_AP6210.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_vendor.conf
endif
endif
endif
################################################################################## AP6476
...
ifeq ($(BLUETOOTH_USE_BPLUS), true)
ifeq ($(BCM_BLUETOOTH_LPM_ENABLE), true)
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_vendor_AP6476_lpm.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_vendor.conf
else
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_vendor_AP6476.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_vendor.conf
endif
endif
    PRODUCT_COPY_FILES += device/khadas/common/bplus/bt_stack.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_stack.conf
endif
################################################################################## AP6330
...
# BPlus
PRODUCT_COPY_FILES += \
    device/khadas/common/bplus/bplus.default.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/bplus.default.so

PRODUCT_COPY_FILES += \
    device/khadas/common/bplus/iop_bt.db:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/iop_bt.db \
    device/khadas/common/bplus/bt_did.conf:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth/bt_did.conf

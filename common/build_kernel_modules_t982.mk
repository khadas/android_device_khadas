...
else ifeq ($(TARGET_PRODUCT),ap223)
LOCAL_DTB := $(PREBUILT_KERNEL_PATH)/ap223.dtb
else
...
ifeq ($(KERNEL_A32_SUPPORT),true)
VENDOR_KERNEL_MODULES += \
    device/amlogic/common/soft_afbc/4.9/32/amlogic_fbc_lib.ko
else
VENDOR_KERNEL_MODULES += \
    device/amlogic/common/soft_afbc/4.9/64/amlogic_fbc_lib.ko
endif
else
ifeq ($(KERNEL_A32_SUPPORT),true)
VENDOR_KERNEL_MODULES += \

...
#########################################################################
PRODUCT_COPY_FILES += \
    device/khadas/common/alarm/alarm_blacklist.txt:$(TARGET_COPY_OUT_VENDOR)/etc/alarm_blacklist.txt \
    device/khadas/common/alarm/alarm_whitelist.txt:$(TARGET_COPY_OUT_VENDOR)/etc/alarm_whitelist.txt

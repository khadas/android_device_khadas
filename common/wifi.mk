...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/6212/config.txt
...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/62X2/config.txt
...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/6255/config.txt
...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/6335/config.txt
...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/4356/config.txt
...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/4354/config.txt
...
PRODUCT_COPY_FILES += device/khadas/kvim/wifi/config.txt:system/etc/wifi/43458/config.txt

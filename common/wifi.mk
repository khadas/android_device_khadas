...
PRODUCT_COPY_FILES += device/khadas/common/wifi/config.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/4358/config.txt
...
PRODUCT_COPY_FILES += hardware/amlogic/wifi/bcm_ampak/config/6212/config.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/6212/config.txt
PRODUCT_COPY_FILES += hardware/amlogic/wifi/bcm_ampak/config/6212/nvram_ap6212.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/6212/nvram_ap6212.txt
...
PRODUCT_COPY_FILES += hardware/amlogic/wifi/bcm_ampak/config/6212/nvram_ap6212a.txt:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/6212/nvram_ap6212a.txt

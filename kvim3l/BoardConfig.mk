...
#hdmi and lcd
HWC_LCD_DISPLAY_NUM                := 2
HWC_LCD_PRIMARY_CONNECTOR_TYPE     := panel
HWC_EXTEND_CONNECTOR_TYPE          := hdmi-only
HWC_PIPELINE                       := dual
HWC_LCD_PRIMARY_FRAMEBUFFER_WIDTH  := 1080
HWC_LCD_PRIMARY_FRAMEBUFFER_HEIGHT := 1920
...
PRODUCT_CUSTOM_IMAGE_MAKEFILES := \
    device/khadas/kvim3l/oem/oem.mk
...
BOARD_AVB_OEM_IMAGE_LIST := \
    device/khadas/kvim3l/oem/oem_4.9/oem.img
else
BOARD_AVB_OEM_PARTITION_SIZE := 33554432
BOARD_AVB_OEM_IMAGE_LIST := \
    device/khadas/kvim3l/oem/oem.img
endif
...
OEM_OTA_CONFIG := device/khadas/kvim3l/oem/oem.prop
endif
